...
{
    public static int TEMP = 350;  // Fahrenheit
    public static int DELAY = 500; // milliseconds
...
//        }
        ...
        while (!quit)
        {
            ...
            {
                MaterialSelectedMenu(selectedMaterial);
...
//                }
    ...
    public static void MaterialSelectedMenu(Material selMat)
    {
        Console.WriteLine("");
        Console.WriteLine("========================================");
        Console.WriteLine("");
...
public class Material 
{
    ...
    // Reference to MatProp object? - Dodgy?
    int delay = MatProp.DELAY/500;
